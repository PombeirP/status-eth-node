...
vendor_dir="${GIT_ROOT}/vendor/github.com/status-im/status-eth-node/bridge/nimbus"
...
# ${vendor_dir}/libnimbus.a(secp256k1.c.o): In function `secp256k1_context_create':
